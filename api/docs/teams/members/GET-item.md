# Получить данные участника команды

|  |  |
|------|------|
| URL | /api/v1/teams/{team_id}/members/{member_id} |
| Service Method | GET |
| Description | Возвращает данные участника команды |
| Return Type | JSON |
...
- **Authorization**: пользователь может получить данные участника команды, к которой у него есть доступ.
...
1. Клиент отправляет `GET /api/v1/teams/{team_id}/members/{member_id}`.
...
```http
GET /api/v1/teams/invalid-team-id/members/invalid-member-id
Authorization: Bearer <access_token>
```
...
```http
GET /api/v1/teams/11111111-1111-1111-1111-111111111111/members/99999999-9999-9999-9999-999999999999
Authorization: Bearer <access_token>
```
