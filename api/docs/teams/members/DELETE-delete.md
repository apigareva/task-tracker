...
- **Authorization**: пользователь может удалять участников только из команды, которой управляет.
...
1. Клиент отправляет `DELETE /api/v1/teams/{team_id}/members/{member_id}`.
...
```http
DELETE /api/v1/teams/invalid-team-id/members/invalid-member-id
Authorization: Bearer <access_token>
```
...
```http
DELETE /api/v1/teams/11111111-1111-1111-1111-111111111111/members/99999999-9999-9999-9999-999999999999
Authorization: Bearer <access_token>
```
