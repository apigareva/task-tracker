...
- **Authorization**: пользователь может удалить только команду, к которому у него есть доступ.
...
1. Клиент отправляет `DELETE /api/v1/teams/{team_id}`.
...
```http
DELETE /api/v1/teams/invalid-id
Authorization: Bearer <access_token>
```
...
```http
DELETE /api/v1/teams/99999999-9999-9999-9999-999999999999
Authorization: Bearer <access_token>
```
