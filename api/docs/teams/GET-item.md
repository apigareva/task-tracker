...
- **Authorization**: пользователь может получить только команду, к которому у него есть доступ.
...
1. Клиент отправляет `GET /api/v1/teams/{team_id}`.
...
```http
GET /api/v1/teams/99999999-9999-9999-9999-999999999999
Authorization: Bearer <access_token>
```
