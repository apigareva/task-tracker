...
| Description | Обновляет текст комментария задачи |
| Return Type | JSON |
...
- **Authorization**: пользователь может обновить только собственный комментарий.
...
1. Клиент отправляет `PATCH /api/v1/tasks/{task_id}/comments/{comment_id}`.
...
```http
PATCH /api/v1/tasks/123e4567-e89b-12d3-a456-426614174000/comments/99999999-9999-9999-9999-999999999999
Authorization: Bearer <access_token>
Content-Type: application/json
