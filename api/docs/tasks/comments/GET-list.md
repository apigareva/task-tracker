...
- **Authorization**: пользователь может получить комментарии задачи, к которой у него есть доступ.
...
1. Клиент отправляет `GET /api/v1/tasks/{task_id}/comments`.
...
```http
GET /api/v1/tasks/invalid-task-id/comments
Authorization: Bearer <access_token>
```
...
```http
GET /api/v1/tasks/99999999-9999-9999-9999-999999999999/comments
Authorization: Bearer <access_token>
```
