...
| Description | Удаляет комментарий задачи |
...
- **Authorization**: пользователь может удалить собственный комментарий или модератор может удалить любой комментарий в доступной задаче.
...
1. Клиент отправляет `DELETE /api/v1/tasks/{task_id}/comments/{comment_id}`.
...
```http
DELETE /api/v1/tasks/invalid-task-id/comments/invalid-comment-id
Authorization: Bearer <access_token>
```
...
```http
DELETE /api/v1/tasks/123e4567-e89b-12d3-a456-426614174000/comments/99999999-9999-9999-9999-999999999999
Authorization: Bearer <access_token>
```
